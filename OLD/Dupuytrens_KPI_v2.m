...
%                     queryList.pageUnfinished.(string(currentSurvey)).data.(sprintf('%s%d', surveyName,phaseNum)).(sprintf('pg%d', pageNum)) = array2table(table2array(queryList.pageStarted.(string(currentSurvey)).data.(sprintf('%s%d', surveyName,phaseNum)).(sprintf('pg%d', pageNum))), 'VariableNames',{'NumParticipantsThatNoFinishPage'});
% 
...
% % spreadsheet ---
% for currentSurvey = {'Enrollment', 'Long', 'Short'}
%     for tableType = {'percentPageCompleted', 'pageCompleted', 'percentPageStarted', 'pageStarted', 'percentPageFinished'}
%         if ~strcmp(currentSurvey, 'Enrollment')
